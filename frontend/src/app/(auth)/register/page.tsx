...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const params = new URLSearchParams({ email: localFormData.email });

      if (verificationResponse.verification_code) {
        params.set("demoCode", verificationResponse.verification_code);
      }
